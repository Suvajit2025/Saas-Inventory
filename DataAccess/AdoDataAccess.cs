...
namespace Invi.DataAccess
{
    public class AdoDataAccess
    {
        ...
        public async Task<int> Int_ProcessAsync(string storedProcedure, string[] parameterNames, object[] parameterValues)
        {
        ...
        public async Task<DataSet> Ds_ProcessAsync(string storedProcedure, string[] parameterNames, object[] parameterValues)
        {
        ...
        public async Task<DataTable> Dt_ProcessAsync(string storedProcedure, string[] parameterNames, object[] parameterValues)
        {
            if (parameterNames.Length != parameterValues.Length)
                throw new ArgumentException("The lengths of parameter names and values must be equal.");
        ...
        public async Task<int> Int_ProcessWithTVPAsync(string storedProcedure, string tvpParameterName, string tableName, DataTable tvpData)
        {
            using (var con = GetConnection())
            using (var cmd = new SqlCommand(storedProcedure, con))
            {
